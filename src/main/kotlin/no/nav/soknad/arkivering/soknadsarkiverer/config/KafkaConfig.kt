...
@Configuration
class KafkaStreamsConfig(private val applicationProperties: ApplicationProperties, private val schedulerService: SchedulerService) {
	...
	fun handleStream(builder: StreamsBuilder): KStream<String, Soknadarkivschema> {
		...
		val inputTopicStream = builder.stream<String, Soknadarkivschema>(applicationProperties.inputTopic)
